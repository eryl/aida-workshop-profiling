...
def main():
    ...
    training_dataset = OxfordIIITPet('datasets', 'trainval', transform=training_preprocess, download=True)
    test_dataset = OxfordIIITPet('datasets', 'test', transforms=test_preprocess, download=True)
